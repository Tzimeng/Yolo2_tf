...
class Train(object):
    def __init__(self, yolo, data):
        ...
        self.output_dir = os.path.join(cfg.DATA_DIR, 'weight')
        ...
        if weight_file is not None:
            ...
            # self.variable_to_reload = self.variable_to_restore[:-2]
            # self.saver = tf.train.Saver(self.variable_to_reload,max_to_keep=None)
